...
sellback = {
    MerchantClass.WEAPONSMITH: [
        ...
        237, 238, 239, 240, 241, 242, 243, 244, 245, 246, 247, 248, 249, 250, 251, 998, 999, 1000, 1001, 1002, 1003,
        1004, 1005,
    ],
    ...
    MerchantClass.TAVERNMASTER: [
        ...
        997, 1006, 1007, 1008, 1009, 1010, 1011, 1012, 1013, 1014, 1015, 1016, 1017, 1018, 1019, 1020, 1021, 1022,
...
# TODO: map the goblin merchant items. (Pickaxe slot = 103)
buy_mapping = {
    MerchantClass.SURGEON: [
        (229, 1), (230, 1), (231, 1), (232, 1)
    ],
    MerchantClass.SANTA: [
        (167, 4), (171, 3), (174, 4), (178, 3), (181, 2), (183, 4), (187, 4), (191, 3), (194, 4), (198, 5), (203, 4),
        (207, 4), (211, 4), (215, 3), (218, 4), (222, 4), (226, 3)
    ],
    MerchantClass.WOODSMAN: [
        (447, 1), (448, 1), (449, 3), (452, 1), (453, 1), (454, 2), (456, 4), (460, 12), (472, 12), (484, 1), (485, 1)
    ],
    MerchantClass.TAILOR: [
        (233, 1), (234, 1), (235, 1), (236, 1), (237, 1), (238, 1), (239, 2), (241, 3), (244, 11), (255, 11)
    ],
    MerchantClass.TREASURER: [
        (269, 1), (270, 1), (271, 1), (272, 1)
    ],
    MerchantClass.LEATHERSMITH: [
        (58, 1), (59, 1), (60, 1), (61, 1), (62, 1), (63, 2), (65, 8), (73, 15), (88, 15)
    ],
    MerchantClass.ARMOURER: [
        (18, 1), (19, 1), (20, 1), (21, 1), (22, 4), (26, 2), (28, 2), (30, 4), (34, 12), (46, 12)
    ],
    MerchantClass.THECOLLECTOR: [
        # the collector has no items to sell
    ],
    MerchantClass.ALCHEMIST: [
        (1, 1), (2, 1), (3, 1), (4, 1), (5, 1), (6, 1), (7, 3), (10, 4), (14, 4)
    ],
    MerchantClass.TAVERNMASTER: [
        (266, 1), (267, 1), (268, 1)
    ],
    MerchantClass.WEAPONSMITH: [
        (342, 1), (343, 2), (345, 2), (347, 1), (348, 1), (349, 5), (354, 3), (357, 4), (361, 7), (368, 7), (375, 9),
        (384, 9), (393, 16), (409, 19), (428, 32), (444, 3)
    ],
    MerchantClass.GOBLINMERCHANT: [
        (486, 216)  # This number is not correct yet
    ],
    MerchantClass.VALENTINE: [
        (273, 4), (277, 3), (280, 8), (288, 5), (293, 4), (297, 4), (301, 5), (306, 5), (311, 5), (316, 4), (320, 4),
        (324, 4), (328, 3), (331, 4), (335, 4), (339, 3)
    ],
    MerchantClass.PUMPKINMAN: [
        (104, 4), (108, 3), (111, 4), (115, 5), (120, 4), (124, 4), (128, 3), (131, 4), (135, 5), (140, 4), (144, 4),
