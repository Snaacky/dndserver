...
from dndserver.protos.Merchant import (SS2C_MERCHANT_LIST_RES, SMERCHANT_INFO, SS2C_MERCHANT_STOCK_BUY_ITEM_LIST_RES, 
                                       SMERCHANT_STOCK_BUY_ITEM_INFO, SC2S_MERCHANT_STOCK_SELL_BACK_ITEM_LIST_REQ,
                                       SC2S_MERCHANT_STOCK_BUY_ITEM_LIST_REQ, SMERCHANT_STOCK_SELL_BACK_ITEM_INFO,
...
def get_buy_list(ctx, msg):
    ...
    # send stage 1 (start) 
    ctx.send(SS2C_MERCHANT_STOCK_BUY_ITEM_LIST_RES(
        result = 1,
        loopMessageFlag = 1,
        stockList = []
    ))
...
def get_sellback_list(ctx, msg):
    ...
    # send stage 1 (start) 
    ctx.send(SS2C_MERCHANT_STOCK_SELL_BACK_ITEM_LIST_RES(
        result = 1,
        loopMessageFlag = 1,
        stockList = []
    ))
    ...
    ctx.send(SS2C_MERCHANT_STOCK_SELL_BACK_ITEM_LIST_RES(
        ...
        stockList = [
            SMERCHANT_STOCK_SELL_BACK_ITEM_INFO(
                stockSellBackId = "DesignDataStockSellBack:Id_StockSellBack_Weaponsmith",
                stockUniqueId = 215
            )
        ]
    ))
