...
from dndserver.protos.Customize import (SC2S_CUSTOMIZE_ITEM_INFO_REQ, SS2C_CUSTOMIZE_CHARACTER_INFO_RES, SS2C_CUSTOMIZE_ITEM_INFO_RES)
from dndserver.protos.Defines import Define_Character, Define_Class, Define_Item
from dndserver.protos.Item import (SCUSTOMIZE_CHARACTER, SCUSTOMIZE_ITEM)
